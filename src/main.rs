...
use days::day12::Day12;
use days::day13::Day13;
use days::day14::Day14;
use days::day15::Day15;
use days::Problem;
...
fn run_day(day: &str) {
    match day {
        ...
        "12" => run(Box::new(Day12 {}), 12),
        "13" => run(Box::new(Day13 {}), 13),
        "14" => run(Box::new(Day14 {}), 14),
        "15" => run(Box::new(Day15 {}), 15),
